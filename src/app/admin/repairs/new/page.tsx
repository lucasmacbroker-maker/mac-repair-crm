              ...
              <>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      📦 Créer le bordereau sur Packlink
                    </a>
                    <input
                      type="file"
                    ...
                    />
                    {bordereauFile && (
                      <p className="text-xs text-green-600">✓ {bordereauFile.name}</p>
                    )}
                    {!bordereauFile && (
                      <p className="text-xs text-[#86868b]">Le devis PDF sera généré automatiquement. Si vous joignez le bordereau, les deux seront envoyés dans un seul email au client.</p>
                    )}
                  </div>
                </div>
              </>
