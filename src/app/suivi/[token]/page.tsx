...
export default function TrackingPage() {
  ...
  return (
    <div className="animate-fadeIn">
            ...
            return (
              ...
              >
                ...
                <div className="pt-1.5 min-w-0">
                  ...
                  {isCurrent && step.key === "UPCOMING" && repair.appointmentDate && (
      ...
      {/* ── Chronopost inbound tracking ───────────────────────────── */}
      {repair.repairType === "POSTAL" && repair.inboundTracking && (
        <div className="mb-6 p-4 bg-blue-50 border border-blue-100 rounded-2xl">
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div className="flex items-center gap-3">
              <span className="text-lg">📦</span>
              <div>
                <p className="text-sm font-medium text-[#1d1d1f]">Suivi Chronopost de votre envoi</p>
                <code className="text-xs font-mono text-[#424245]">{repair.inboundTracking}</code>
              </div>
            </div>
            <a
              href={`https://www.chronopost.fr/tracking-no-cms/suivi-page?listeNumerosLT=${repair.inboundTracking}`}
              target="_blank"
